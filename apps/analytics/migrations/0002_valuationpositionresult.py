# Generated by Django 5.2 on 2025-12-31 22:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "market_value_original_currency_currency",
                ...
                (
                    ...
                    djmoney.models.fields.MoneyField(
                        ...
                        max_digits=20,
                        verbose_name="Market Value (Original Currency)",
                    ),
                ),
                (
                    "market_value_base_currency_currency",
                    djmoney.models.fields.CurrencyField(
                        choices=[
                            ("XUA", "ADB Unit of Account"),
                            ("AFN", "Afghan Afghani"),
                ...
                (
                    ...
                    djmoney.models.fields.MoneyField(
                        ...
                        max_digits=20,
                        verbose_name="Market Value (Base Currency)",
                    ),
                ),
                (
                    "fx_rate_used",
                ...
                (
                    ...
                    models.JSONField(
                        ...
                        verbose_name="Data Quality Flags",
                    ),
                ),
                (
                    "created_at",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="portfolios.positionsnapshot",
                    ),
                ),
                (
                    "valuation_run",
            ...
            options={
                "verbose_name": "Valuation Position Result",
                "verbose_name_plural": "Valuation Position Results",
                "ordering": ["valuation_run", "position_snapshot"],
                "indexes": [
                    models.Index(
                        fields=["organization", "valuation_run"],
                        name="analytics_v_organiz_769792_idx",
                    ),
                    models.Index(
                        fields=["organization", "position_snapshot"],
                        name="analytics_v_organiz_4aad94_idx",
                    ),
                ],
                "constraints": [
